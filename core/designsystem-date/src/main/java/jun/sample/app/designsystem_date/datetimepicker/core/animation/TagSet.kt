    ...
    return when (name) {
        ...
        "accelerateInterpolator" ->
            attrs.attrs(
                ...
                if (factor == 1.0f) AccelerateEasing else AccelerateEasing(
                    factor
                )
            }
        "decelerateInterpolator" ->
            attrs.attrs(
                ...
                if (factor == 1.0f) DecelerateEasing else DecelerateEasing(
                    factor
                )
            }
        ...
        "anticipateOvershootInterpolator" ->
            attrs.attrs(
                ...
                AnticipateOvershootEasing(
                    ...
                    a.getFloat(
                        AndroidVectorResources.STYLEABLE_ANTICIPATEOVERSHOOT_INTERPOLATOR_EXTRA_TENSION,
                        1.5f
                    )
                )
            }
